...
\vspace{-2cm}
\section{Al-Khaser}
Al-Khaser is ... . For this reason we use it as validation as well as a running example.
Running BlueTracer with Al-Khaser in its default mode -> ok , not detected. So detection aspect is ok. Now let us instead examine some of the Native API, APIs traced by BlueTracer to assess its tracing capabilities.
Al-Khaser categorizes checks blabla. Let us look at some examples from the main categories.
