...
\bigskip
    	...
    	\vspace{-0.3cm}
    	%\hspace*{1cm}
        \includegraphics[width=7cm]{image/BluePill.pdf}
    \end{figure}

\end{frame}

\begin{frame}
    \frametitle{BlueTracer: challenges and features}
\setbeamerfont*{itemize/enumerate subbody}{parent=itemize/enumerate body}    
    
\textcolor{sapienza}{\textbf{Implementation challenges:}}

\begin{itemize}
\item Heterogeneity of Windows libraries used in malware and the lack of well-structured documentation for their prototypes
\begin{itemize}
...
\end{beamerboxesrounded}
\bigskip    
\textbf{Example}: file system artifacts can be checked in order to uncover the presence of a virtualized environment.
\vspace*{0.3cm}
...
malware.
	...
	\begin{itemize}
	\item Adoption of an automatic methodology for large-scale evaluation 
