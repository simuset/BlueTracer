...
In this section we will describe how API are analyzed before execution, i.e. the x function in Figure y.
The workflow here is mostly the same as NTAPI's with one major difference the introduction of a shadow stack used to store API entries in the TLS, which will be motivated later in the section.
