...
\item The address of the APC to be invoked is obtained by adding 4 to the stack pointer and fetching the pointed value. In fact, such address is located right on top of the APC's dispatcher return address.
\end{enumerate}
